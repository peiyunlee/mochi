...
public abstract class jellyTest : MonoBehaviour
{
    ...
    void CreateRigidBodiesLine(Bounds spriteBounds)
    {
        ...
        if (filpLine)
        {
            ...
            {
                Vector2 position;
                position.y = (-width * 0.5f) + ((width / (float)(numPoints - 1)) * x);
                position.x = 0.0f;
    ...
    ReferencePoint AddReferencePoint(Vector3 position, float radius, bool lockRotation)
    {
        ...
        if (m_2DMode)
        {
            ...
            // else{
            // 	newRigidBody.freezeRotation=false;
            // }
    ...
    public void SetPosition(Vector3 position, bool resetVelocity)
    {
        ...
        foreach (jellyTest.ReferencePoint referencePoint in ReferencePoints)
        {
            if (!referencePoint.IsDummy)
            {
